  ...
  try {
    ...
    if (query) {
      ...
      sqlQuery = `
        ...
        WHERE 
          (i.item_name ILIKE $1 OR sem.semester_name ILIKE $1 OR cl.class_name ILIKE $1 OR s.first_name ILIKE $1 OR s.last_name ILIKE $1 OR st.first_name ILIKE $1 OR st.last_name ILIKE $1) AND si.status != 'deleted'
        ORDER BY 
