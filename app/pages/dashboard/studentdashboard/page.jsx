...
const Studentdashboard = () => {
  ...
  const fetchAllData = async (userId, semester_id) => {
    ...
    const [studentdata, events, classesdata, notifications, semestersdata] =
      await Promise.all([
        fetchData(
    ...
    setStudentData(studentdata), setGradeData(studentdata?.gradeData);
    setAttendanceData(studentdata?.attendanceData);
    setWeeklyTeachingHours(studentdata?.totalWeeklyHours);
    setStudentClass(studentdata?.studentInfo?.class_id);
