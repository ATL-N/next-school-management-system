...
const AdminDashboard = () => {
  ...
  const fetchEnrollmentData = async () => {
    ...
    setTotalstaff(enrolementData?.totalStaff);
    setTotalParents(enrolementData?.totalParents);
    setTotalusers(enrolementData?.totalUsers);
  };
  ...
  const fetchFinancialData = async () => {
    ...
    setMonthlyRevenue(financialdata?.currentMonthRevenue);
    setDaillyRevenue(financialdata?.currentDayRevenue);
  };
