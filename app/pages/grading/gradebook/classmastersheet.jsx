...
const ClassMasterSheet = ({ onClose, onSave, userRole, class_id }) => {
  ...
  const handlePrint = () => {
    const doc = GenerateClassMasterSheetPDF(
      studentsData,
      subjects,
      semesterData,
      classesData,
    ...
    // doc.save(`Class_Master_Sheet_${selectedClass}_${selectedSemester}.pdf`);
