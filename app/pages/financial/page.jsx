    ...
    <div className="pb-16 text-cyan-600">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <StatCard
          ...
          value={`GHC ${
            financialStats?.totalPaymentsToday?.toFixed(2).toLocaleString() || 0
          }`}
        />
        <StatCard
          icon={<FaChartLine />}
      ...
      <div className="grid grid-cols-1 md:grid-cols-1 gap-6 mb-6">
        <div className="bg-white p-4 rounded shadow">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-4 gap-4">
            ...
            >
              <FaMoneyCheckAlt className="mx-auto mb-2 text-2xl" /> Add New Bill
            </button>
            ...
            <button
              ...
              className="p-4 bg-cyan-100 rounded-lg text-center hover:bg-cyan-200 transition duration-300"
            >
              <FaBookOpenReader className="mx-auto mb-2 text-2xl" /> View
              Student Bill
            </button>
            ...
            <button
              ...
              className="p-4 bg-cyan-100 rounded-lg text-center hover:bg-cyan-200 transition duration-300"
            >
              <FaFileAlt className="mx-auto mb-2 text-2xl" /> View Bills
            </button>
