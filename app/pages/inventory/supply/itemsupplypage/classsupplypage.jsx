...
const ClassSupplyManagement = ({ onCancel, isReadOnly=false }) => {
  ...
  const fetchClassandSemester = async () => {
    ...
    try {
      ...
      console.log("procurements", classdata?.classes);
    } catch (err) {
  ...
  const handleClassChange = (e) => {
    ...
    //   fetchItemData(e.target.value, selectedSemesterId);
    //   loadSupplies(e.target.value, selectedSemesterId);
    // }
  };
  ...
  const handleSemesterChange = (e) => {
    ...
    // if (selectedClassId && selectedSemesterId) {
    //   fetchItemData(selectedClassId, e.target.value);
    //   loadSupplies(selectedClassId, e.target.value);
    // }
  };
